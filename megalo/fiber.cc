...
static Logger::ptr g_logger = MEGALO_LOG_NAME("system");
...
void Fiber::reset(std::function<void()> cb){
  MEGALO_ASSERT(m_stack);
  MEGALO_ASSERT(m_state == TERM 
      || m_state == INIT);
...
Fiber::ptr Fiber::GetThis(){
  ...
  MEGALO_ASSERT(t_fiber == main_fiber.get());
