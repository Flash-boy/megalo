...
int32_t FunctionServlet::handle(megalo::http::HttpRequest::ptr request
                        , megalo::http::HttpResponse::ptr response
                        , megalo::http::HttpSession::ptr session){
...
int32_t ServletDispatch::handle(megalo::http::HttpRequest::ptr request
                        , megalo::http::HttpResponse::ptr response
                        , megalo::http::HttpSession::ptr session){
...
int32_t NotFoundServlet::handle(megalo::http::HttpRequest::ptr request
                        , megalo::http::HttpResponse::ptr response
                        , megalo::http::HttpSession::ptr session){
  static const std::string& RSP_BODY = "<html><head><title>404 Not Found"
                                       "</title></head><body><center><h1>404 Not Found</h1></center>"
                                       "<hr><center>megalo/1.0.0</center></body></html>";

  response->setStatus(megalo::http::HttpStatus::NOT_FOUND);
  response->setHeader("Content-type", "text/html");
  response->setHeader("Server", "megalo/1.0.0");
